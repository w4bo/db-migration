# expdp frenchelectricity/oracle@xe directory=oracle_dump dumpfile=frenchelectricity.dmp SCHEMAS=frenchelectricity
# expdp frenchelectricityext/oracle@xe directory=oracle_dump dumpfile=frenchelectricityext.dmp SCHEMAS=frenchelectricityext
...
# expdp ssb_flight/oracle@xe directory=oracle_dump dumpfile=ssb_flight.dmp SCHEMAS=ssb_flight
chmod -R 777 /data
ls -las /data
